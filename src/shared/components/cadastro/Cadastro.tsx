...
import { Box, Button, Card, CardActions, CardContent, CircularProgress, Snackbar, TextField, Typography } from '@mui/material';
...
export const Cadastro: React.FC<ICadastroProps> = ({ children }) => {
    ...
    return (
        <Box width='100vw' height='100vh' display='flex' alignItems='center' justifyContent='center' style={{ backgroundImage: `url(${tenor})`, backgroundSize: "cover" }}>
            <Card>
                <CardContent>
